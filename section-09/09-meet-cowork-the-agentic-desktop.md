...
**Global instructions vs. per-folder instructions.** Cowork supports two levels of standing instructions: instructions that apply across all Cowork work, and instructions specific to a folder or workspace. Knowing which to use for which type of guidance prevents conflicts.
