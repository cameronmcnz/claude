...
- Quick tasks you'd otherwise postpone ("I'll do that when I'm at my desk")
- First drafts of messages, updates, or documents where the raw content matters more than perfect structure
- Brain dumps where you have a lot of information in your head that needs organizing
- Reviewing and responding to items while away from your desk

It's less effective for:
- Tasks requiring precise formatting or structured prompts where typing is faster than speaking formatting instructions
- Long prompts with specific technical requirements where review is critical
- Situations where speaking aloud isn't practical
