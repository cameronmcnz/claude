...
A Mermaid flowchart explaining Retrieval-Augmented Generation — from user question through retrieval to final answer.
...
- *"Add color to the Yes and No branches"*
- *"Add a step for re-ranking retrieved chunks before sending to the LLM"*
- *"Make a left-right (LR) layout version"*
