...
Once Claude generates the artifact, try asking for variations:

- *"Make the snake neon green on a black background"*
- *"Add a pause button"*
- *"Add sound effects when the snake eats food"*
- *"Make the walls wrap instead of ending the game"*
